...
//------------------------------------------------------------------------------
//2026 May 05 - (eu2av)//Here is the corrected cpl_cordic.v module with the added Phase Dither.
//The changes are marked with comments // [2.1] Phase Dither.///
...
parameter OUT_WIDTH = WR;

localparam WR =  IN_WIDTH + EXTRA_BITS + 2;
