...
entity datetime is
  ...
  -- Time information
  constant HOUR_INT   : integer                       := 15;
  constant HOUR_HEX   : std_logic_vector(7 downto 0)  := X"15";
  constant MINUTE_INT : integer                       := 13;
  constant MINUTE_HEX : std_logic_vector(7 downto 0)  := X"13";
  constant SECOND_INT : integer                       := 35;
  constant SECOND_HEX : std_logic_vector(7 downto 0)  := X"35";
  constant TIME_HEX   : std_logic_vector(31 downto 0) := X"00" & HOUR_HEX & MINUTE_HEX & SECOND_HEX;
  -- Miscellaneous information
  constant EPOCH_INT  : integer := 1741119215;  -- Seconds since 1970-01-01_00:00:00
